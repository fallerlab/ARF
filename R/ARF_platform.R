...
#' @param PDB_chains_2_RP_nomenclature Alternative data.frame that maps chain IDs to RP names and new nomenclature. Required columns are ID, RP_name, RP_new, chainID.
#' @param download_directory Directory for downloads, default=getwd()
#' @param method Which analysis to perform , default:"dripARF_minDistances" which calculates rRNA-RP min distances. (No other option yet)
#' @param outprefix Prefix for the file to save results within, default: "Ribosome.3D"
